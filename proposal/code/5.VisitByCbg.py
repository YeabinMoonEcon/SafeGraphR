...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 19 20:08:25 2020
...
temp = (df.FIPS == '06001') | (df.FIPS == '06075')
AlSfCounty = df.loc[temp,:]
AlSfCounty = AlSfCounty[['date','cbg','safegraph_place_id','size','visits']]

total = AlSfCounty.groupby(['date', 'cbg'])['visits'].sum()
total = total.reset_index()
total = total.pivot(index= 'cbg', columns = 'date', values = 'visits')
total.fillna(0, inplace = True)
total.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_total.csv')



size0 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 0,:]
...
size0.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size0.csv')


size1 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 1,:]
...
size1.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size1.csv')


size2 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 2,:]
...
size2.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size2.csv')


size3 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 3,:]
...
size3.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size3.csv')


size4 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 4,:]
...
size4.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size4.csv')


size5 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 5,:]
...
size5.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size5.csv')


size6 = AlSfCounty.loc[AlSfCounty.loc[:,'size'] == 6,:]
...
size6.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size6.csv')
