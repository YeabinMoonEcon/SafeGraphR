...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 27 18:57:07 2020
...
temp = (temp_df.loc[:,'FIPS'] == '06001') | (temp_df.loc[:,'FIPS'] == '06075') \
        | (temp_df.loc[:,'FIPS'] == '06085') | (temp_df.loc[:,'FIPS'] == '06081') \
        | (temp_df.loc[:,'FIPS'] == '06013') | (temp_df.loc[:,'FIPS'] == '06041') \
...
total_device.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/output/data/device_total.csv')
home_device.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/output/data/device_home.csv')
social_distancing.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/output/data/device_distancing.csv')
