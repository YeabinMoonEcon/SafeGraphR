...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 25 11:26:56 2020
...
visits_total = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_total.csv',
                          dtype = {'cbg':str})
...
visits_total_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_total_zip.csv')

visits_total_zip.reset_index(inplace = True)

visits_total_zip.loc[:,'variance'] = visits_total_zip.iloc[:, :8].var(axis = 1)
visits_total_zip.loc[:,'base'] = visits_total_zip.iloc[:, :8].mean(axis = 1)

visits_size0 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size0.csv',
                          dtype = {'cbg':str})
...
visits_size0_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size0_zip.csv')


visits_size1 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size1.csv',
                          dtype = {'cbg':str})
...
visits_size1_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size1_zip.csv')
...
visits_size2 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size2.csv',
                          dtype = {'cbg':str})
...
visits_size2_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size2_zip.csv')


visits_size3 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size3.csv',
                          dtype = {'cbg':str})
...
visits_size3_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size3_zip.csv')



visits_size4 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size4.csv',
                          dtype = {'cbg':str})
...
visits_size4_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size4_zip.csv')


visits_size5 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size5.csv',
                          dtype = {'cbg':str})
...
visits_size5_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size5_zip.csv')


visits_size6 = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size6.csv',
                          dtype = {'cbg':str})
...
visits_size6_zip.to_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/proposal/data/visits_size6_zip.csv')
