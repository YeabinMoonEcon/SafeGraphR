...
df = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/data/temp/monthly/202001.csv',
                      index_col = 0)


for month in month_list:
    df_temp = pd.read_csv('/Users/yeabinmoon/Dropbox (UH-ECON)/Thesis/data/temp/monthly/2019'+month+'.csv',
                          index_col = 0)
